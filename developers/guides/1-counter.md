...
* A complete copy of all code provided in this guide can be found in the [**examples repo**](https://github.com/clockwork-xyz/examples/tree/main/1-counter)****[ ](https://github.com/clockwork-xyz/examples/tree/main/1-counter)on GitHub.
